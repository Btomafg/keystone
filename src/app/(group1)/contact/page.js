            ...
            <section className='mb-8'>
                <div className='container-fluid '>
                    <SectionTitle sectionName={"Inquiry"} sectionTitle={"Have a Project in your mind?"} sectionDesc={<div className='flex flex-col w-full  px-12'>
                        ...
                        <a href='https://link.buoycrm.com/widget/booking/iusHrn919zNeEGjFvK4k' target='blank_'><ButtonFill className='ms-3 my-auto'>Schedule A Consultation</ButtonFill></a>
                    </div>} />
                </div>
                     ...
                     <div className='grid lg:grid-cols-2 gap-x-5'>
                        ...
                        <InputField name="firstName" placeholderc={"First Name"} type={"firstName"} className={"mb-[13px]"} />
                            ...
                            <div className='flex justify-end mt-2'>
                                <ButtonOutline type='submit'>Send Message <RightArrow height={"22"} width={"35"} /></ButtonOutline>
