                  ...
                  <div className="xl:pt-[200px] pt-[150px] pb-[250px]">
                    <div>
                      <h1 className="2sm:text-[105px] sm:text-[100px] xm:text-6xl text-xl leading-[100%] font-bold relative">
                        <span className={cn(`text-primary-foreground  animate-fill animate-bg after:${bg_muted} ${text_muted}`)}>
                          {' '}
                          {heading_one}{' '}
                        </span>
                        <svg
                          strokeWidth="2"
                          className="stroke-primary  fill-transparent stroke-dasharray-1000 stroke-dashoffset-1000 animate-text-line-animation w-full 2sm:h-[200px] h-25 text-animation"
                        >
                          <text x="0%" dominantBaseline="middle" y="50%">
                            {heading_two}
                          </text>
                        </svg>
                      </h1>
