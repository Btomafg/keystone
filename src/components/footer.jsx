            ...
            <div className=' bg-secondary '>
                <div className='container'>
                        ...
                        <div className='mt-12 lg:mt-0 flex gap-x-10'>
                            ...
                            <div>
                                ...
                                <div className='mt-[17px]'>
                                    <Link href={"tel:+18143127972"} className='text-lg block text-primary-foreground hover-underline' >Phone: <span>814 312 7972</span></Link>
                                    <Link href={"mailto:contact@keystonewoodworx.com"} className='text-lg block text-primary-foreground hover-underline'>Email: <span>contact@keystonewoodworx.com</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='py-8 lg:flex justify-between items-center'>
                        <span className='text-sm text-primary-foreground block'>Made with Love by <Link className='text-blue-400' href={"https://www.btllabs.com"}>BTL Labs</Link> </span>
