...
const OptionStep: React.FC<OptionStepProps> = ({ customOptions, onOptionComplete }) => {
  ...
  const stepLabels = ['Door Material', 'Sub Material', 'Construction Method', 'Toe Style', 'Crown', 'Light Rail'];
  ...
  const allOptions = [doorMaterialOptions, subMaterialOptions, constructionMethodOptions, toeStyleOptions, crownOptions, lightRailOptions];
