        ...
        <Form {...passwordForm}>
          <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="flex flex-col space-y-4">
            ...
            {passwordForm.watch('newPassword').length > 0 && (
              <div className="flex max-w-[300px]"><PasswordChecker password={passwordForm.watch('newPassword')} /></div>
            )}


            <Button className="ms-auto" type="submit">Update Password</Button>
          </form>
        </Form>
      </div>
      ...
      <div>
        ...
        <Form {...mfaForm}>
          <form onSubmit={mfaForm.handleSubmit(onMFASubmit)} className="flex flex-col space-y-4">
            ...
            />
            <Button className="ms-auto" type="submit">Add MFA</Button>
          </form>
        </Form>
      </div>
    </div>
